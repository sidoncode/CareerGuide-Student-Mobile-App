...
public class Live_counsellor extends AppCompatActivity {
    private String PRIVATE_SERVER = "https://app.careerguide.com/api/counsellor/";
    ...
    private void save_report_url(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, PRIVATE_SERVER + "get_live_counsellor", response -> {
