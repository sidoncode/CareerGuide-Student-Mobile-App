...
public class YT_recycler_adapter_POSTGRA extends RecyclerView.Adapter<YT_recycler_adapter_POSTGRA.MyViewHolder> {

    private List<Videos_POSTGRA> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_POSTGRA(List<Videos_POSTGRA> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_POSTGRA video = videoList.get(position);
