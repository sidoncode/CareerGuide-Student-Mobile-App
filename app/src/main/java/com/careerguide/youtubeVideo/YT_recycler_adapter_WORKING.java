...
public class YT_recycler_adapter_WORKING extends RecyclerView.Adapter<YT_recycler_adapter_WORKING.MyViewHolder> {

    private List<Videos_WORKING> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_WORKING(List<Videos_WORKING> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_WORKING video = videoList.get(position);
