...
public class YT_recycler_adapter_NINE extends RecyclerView.Adapter<YT_recycler_adapter_NINE.MyViewHolder> {

    private List<Videos_NINE> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_NINE(List<Videos_NINE> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_NINE video = videoList.get(position);
