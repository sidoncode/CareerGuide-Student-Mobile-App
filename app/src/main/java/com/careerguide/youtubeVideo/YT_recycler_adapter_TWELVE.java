...
public class YT_recycler_adapter_TWELVE extends RecyclerView.Adapter<YT_recycler_adapter_TWELVE.MyViewHolder> {

    private List<Videos_TWELVE> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_TWELVE(List<Videos_TWELVE> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_TWELVE video = videoList.get(position);
