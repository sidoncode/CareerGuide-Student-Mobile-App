...
public class YT_recycler_adapter_two extends RecyclerView.Adapter<YT_recycler_adapter_two.MyViewHolder> {

    private List<Videos_two> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_two(List<Videos_two> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_two video = videoList.get(position);
