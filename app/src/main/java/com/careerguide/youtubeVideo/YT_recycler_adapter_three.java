...
public class YT_recycler_adapter_three extends RecyclerView.Adapter<YT_recycler_adapter_three.MyViewHolder> {

    private List<Videos_three> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_three(List<Videos_three> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_three video = videoList.get(position);
