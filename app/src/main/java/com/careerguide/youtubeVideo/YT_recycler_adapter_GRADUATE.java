...
public class YT_recycler_adapter_GRADUATE extends RecyclerView.Adapter<YT_recycler_adapter_GRADUATE.MyViewHolder> {

    private List<Videos_GRADUATE> videoList;
    private String key;
...
//            cardView.setRadius(cornerRadius);
    ...
    YT_recycler_adapter_GRADUATE(List<Videos_GRADUATE> videoList, String yt_key, Activity activity, int cornerRadius, int textColor) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Videos_GRADUATE video = videoList.get(position);
