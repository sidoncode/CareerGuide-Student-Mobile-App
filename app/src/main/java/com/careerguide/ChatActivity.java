...
public class ChatActivity extends AppCompatActivity implements Observer
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.cemeraButton).setOnClickListener(v -> CropImage.activity()
        ...
        typingRequest = new StringRequest(Request.Method.POST, Utility.PRIVATE_SERVER + "student_typing", response -> {
        ...
        typingRunnable = () -> typingIndicator.setVisibility(View.GONE);
    }
    ...
    private void getHistory() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.PRIVATE_SERVER + "get_chat", response -> {
    ...
    private void sendMessage(final ChatMessage chatMessage, final Bitmap bitmap)
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, /*"http://app.careerguide.com/api/counsellor/chat_to_user"*/ Utility.PRIVATE_SERVER + "chat_to_counsellor", response -> {
