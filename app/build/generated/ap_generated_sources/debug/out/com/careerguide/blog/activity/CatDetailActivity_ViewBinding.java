...
public class CatDetailActivity_ViewBinding implements Unbinder {
  private CatDetailActivity target;

  @UiThread
  public CatDetailActivity_ViewBinding(CatDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CatDetailActivity_ViewBinding(CatDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CatDetailActivity target = this.target;
