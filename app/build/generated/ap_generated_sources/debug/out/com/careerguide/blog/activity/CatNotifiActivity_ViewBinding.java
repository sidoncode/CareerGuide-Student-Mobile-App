...
public class CatNotifiActivity_ViewBinding implements Unbinder {
  private CatNotifiActivity target;

  @UiThread
  public CatNotifiActivity_ViewBinding(CatNotifiActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CatNotifiActivity_ViewBinding(CatNotifiActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CatNotifiActivity target = this.target;
