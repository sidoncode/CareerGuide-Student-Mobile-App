...
public class CatListActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CatListActivity_ViewBinding(CatListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CatListActivity_ViewBinding(CatListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CatListActivity target = this.target;
